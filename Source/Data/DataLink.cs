...
namespace BusinessLayer.Data
{
    public sealed partial class DataLink : IDataLink
    {
        ...
        // REMOVE: private readonly string connectionString;
        // ADD: Use DatabaseConnection for connection management
        ...
        private DataLink()
        {
            try
            {
                // Create DatabaseConnection instead of building connection string
        ...
        private SqlConnection CreateConnection()
        {
            ...
            // MODIFIED: Use DatabaseConnection to get the connection
        ...
        public async Task ExecuteNonQueryAsync(string storedProcedure, SqlParameter[]? sqlParameters = null)
        {
            try
            {
                // MODIFIED: Use DatabaseConnection's connection string
                using var connection = new SqlConnection(databaseConnection.GetConnectionString());
                using var command = new SqlCommand(storedProcedure, connection)
                {
                    CommandType = CommandType.StoredProcedure
