...
{
    /// <summary>
    /// Validates email, reset code, and new password for password reset operations.
    /// </summary>
    public class PasswordResetValidator
    {
        ...
        /// <summary>
        /// Validates that a reset code is a 6-digit number.
        /// </summary>
        ...
        /// <summary>
        /// Validates a new password against length and character requirements.
        /// </summary>
