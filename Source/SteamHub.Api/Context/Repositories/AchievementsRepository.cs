...
namespace SteamHub.Api.Context.Repositories
{
    ...
    => context.Achievements
        ...
        public SteamHub.ApiContract.Models.AchievementUnlockedData GetUnlockedDataForAchievement(int userIdentifier, int achievementId)
        {
            var ua = context.UserAchievements
            ...
            return new SteamHub.ApiContract.Models.AchievementUnlockedData
            {
                AchievementName = ua.Achievement.AchievementName,
        ...
        public List<SteamHub.ApiContract.Models.AchievementWithStatus> GetAchievementsWithStatusForUser(int userIdentifier)
        {
            ...
            return all.Select(a => new SteamHub.ApiContract.Models.AchievementWithStatus
            {
                Achievement = a,
